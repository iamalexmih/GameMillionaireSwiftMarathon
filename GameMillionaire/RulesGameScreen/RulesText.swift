...
//  GameMillionaire
//
//  Created by Эдгар Исаев on 09.02.2023.
//
...
struct Rules {
    let rules = String( """
                  ...
                  Вопросы, сгруппированные на одном уровне, будут иметь одинаковую сложность. Например: вопросы 1-5 составляют первый уровень и будут содержать самые простые вопросы. Второй уровень (вопросы 6–10) будет несколько сложнее, за ним следует третий самый сложный уровень (вопросы 11–15).
